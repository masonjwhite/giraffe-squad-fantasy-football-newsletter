...
export const article: MainArticle = {
  ...
  summary: 'Is the tight end position still relevant? Mason and Adam struggle with ghosts. Jackie TBD',
  author: 'Mason White, Commissioner',
  content: (
    <>
      <Paragraph>
        It's the end of the tight end position as we know it.
      </Paragraph>
      <Paragraph>
        Let me know if this rings a bell. You're hyped for another week of fantasy football.
        You and your opponent are projected within 10 points of eachother. It's going to be close.
        You turn on NFL Red Zone and obsessively refresh your app with Cheeto-stained fingers.
        Your team is flamin hot, but then you notice something...your tight end has a score of 0.
        You think "well it's just a slow start, he'll turn it around."
      </Paragraph>
      <Paragraph>
        He doesn't. You lose by 12 points. Your tight end finishes with 3.2 points.
      </Paragraph>
      <Image
        src="https://media.giphy.com/media/udv8jAcfnPaIU/giphy.gif?cid=790b7611su042jshmjigv6l00o00vk7o782r349owv3f1zn8&ep=v1_gifs_search&rid=giphy.gif&ct=g"
      />
      <Paragraph>
        If this has happened to you, you might be entitled to financial compensation.
      </Paragraph>
      <Paragraph>
        The tight end position has become a bit of a pariah lately in fantasy football. Sure you have a few breakout games
        here and there, but how many dominant tight ends are there? Two? Maybe three?
      </Paragraph>
      <Paragraph>
        The rest of us are forced to face the Was(TE)land, a desolate landscape of disappointment and consistent sub 10-point performances.
      </Paragraph>
      <Paragraph>
        Fun fact. Not a single tight end on the waiver wire at the time of writing this article is projected more than 8 points.
      </Paragraph>
      <Paragraph>
        Another fun fact. You could have better production right now by picking up Greg Zurlein, the kicker for the New York Jets, than any available tight end.
      </Paragraph>
      <Paragraph>
        One more. Kyle Juszczyk, a FULLBACK, has more points than a few of the "high profile" tight ends.
      </Paragraph>
      <Image
        src="https://media.giphy.com/media/tT11BeHhm9RLi/giphy.gif?cid=790b7611ac0fg79c8dj69cecw6c7aywbe4heq707ryfip7f7&ep=v1_gifs_search&rid=giphy.gif&ct=g"
      />
      <Paragraph>
        I caught up with some of the Coaches navigating this tricky landscape.
      </Paragraph>
      <Paragraph>
        First up is Coach Mason of <TeamName teamName="Joey B & The Q-Tips" />, who is dealing with a ghost. Specifically, the ghost of Mark Andrews.
      </Paragraph>
      <Interview
      ...
      />
      <Paragraph>
        Folks, we almost had a blockbuster trade early this season. I heard through the rumor mill that Coach Jackie
        of <TeamName teamName="Pattibot" /> attempted to broker a trade with Coach Jaime of <TeamName teamName="Jaiwalking to Victory" />
      ...
      />
      <Paragraph>
        Next up, we head down to the farm with Coach Adam of <TeamName teamName="Henry's Hustle" />. His
        tight end, Jake Ferguson, recently laid an egg in Week 2.
      </Paragraph>
      <Interview
        interviewerImage={commissionerImg}
        interviewerName="Mason White, Commissioner"
      ...
      />
      <Paragraph>
        So there you have it folks. Is the tight end position no longer relevant?
        Should I spend more energy drafting my kicker than my tight end? Are fantasy leagues going to add fullbacks?
      ...
      <Paragraph>
        For all those out there in the Was(TE)land, stay safe!
      </Paragraph>
    </>
  ),
};
...
export const jokeArticles: JokeArticle[] = [
  ...
  {
    title: "Miami Dolphins announce Carrot Top as their new starting quarterback: 'we like how he matches the uniforms'",
