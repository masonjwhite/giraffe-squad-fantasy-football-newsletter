          ...
          >
            ...
            >
              <Text c="dimmed" size="sm">
                ...
                league today. The OGs included: Adam, Kara, Mason, Mike, Zac and Zari.
              </Text>
              <Text size="xs" mt={4}>
            ...
            >
              <Text c="dimmed" size="sm">
                ...
                Fantasy Newsletter as a simple text-based post in an effort to bring some laughs and
            ...
            >
              <Text c="dimmed" size="sm">
                To further amplify the 5th anniversary festivities, Mason also announced the
                inagural Giraffe Squad Fantasy Football trophy, which will be awarded for the first
                time to the 2024 Champion!
              </Text>
              <Text size="xs" mt={4}>
                September 4, 2024 | 31 AD
              </Text>
            ...
            >
              <Text c="dimmed" size="sm">
                ...
                Giraffe Squad Fantasy Football Newsletter. It even included support for multiple
                weeks allowing everyone to follow the action all season in one place. If you're
                reading this, you're on it!
              </Text>
              <Text size="xs" mt={4}>
